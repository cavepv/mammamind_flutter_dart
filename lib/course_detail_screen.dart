    ...
    return MammaMindPage(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: MammaMindSpacing.sm),
          Text(MammaMindData.courseBabyNote,
              style: Theme.of(context).textTheme.bodyMedium),
          const SizedBox(height: MammaMindSpacing.sm),
          Card(
            child: Padding(
          ...
          const SizedBox(height: MammaMindSpacing.sm),
          Text(MammaMindData.courseClosing,
              style: Theme.of(context).textTheme.bodyMedium),
          const SizedBox(height: MammaMindSpacing.xs),
          Text('Till alla som bokar bjuder vi på:',
              style: Theme.of(context).textTheme.bodyMedium),
          Text('• ${MammaMindData.courseEarlyBirdNote}',
              style: Theme.of(context).textTheme.bodyMedium),
          const SizedBox(height: MammaMindSpacing.xs),
          Text.rich(
            TextSpan(
          ...
          ElevatedButton(
            ...
            child: Text('Köp plats – ${MammaMindData.coursePriceSek} kr'),
          ),
